...
void add_song(std::list<Song>& playlist, const Song& current_song)
{
    std::string name{};
    std::string artist{};
    int rating{};
    ...
    std::cout << "Enter song name: "; std::getline(std::cin, name);
    std::cout << "Enter song artist: "; std::getline(std::cin, artist);
...
int main() 
{
    ...
    do
    {
        ...
        case 'n':
            ...
            {
                std::cout << "Wrapping to the start of the list" << std::endl;
        ...
        case 'p':
            ...
            {
                std::cout << "Wrapping to the end of the list" << std::endl;
